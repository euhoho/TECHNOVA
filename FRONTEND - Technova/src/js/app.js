...
document.addEventListener('DOMContentLoaded', () => {
    ...
    /* ── Actualizar contador navbar cuando cargue ── */
...
if (terminalBody && networkCanvas) {
    ...
    let stepIndex = 0, charIndex = 0, currentEl = null, animId = null;
    ...
    function switchToNetwork() {
        const savedW = terminalBody.offsetWidth, savedH = terminalBody.offsetHeight;
